...
/* map subscribeol odatára, a regionName, és countyName változásokra 
 * ha nincs countyname, akkor csak regionname poligonokat színezi ki
 * ha van countyname, akkor a megyét színezi ki
 */
