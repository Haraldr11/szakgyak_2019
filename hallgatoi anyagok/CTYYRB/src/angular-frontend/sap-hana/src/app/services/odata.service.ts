...
export class OdataService {
  ...
  areaUrl: string = "";
  areaSubject: BehaviorSubject<string> = new BehaviorSubject<string>("");

  regionName: string = "";
  countyName: string = "";
  cityName: string = "";

  regionSubject: BehaviorSubject<string> = new BehaviorSubject<string>("Dél-Alföld régió");
  countySubject: BehaviorSubject<string> = new BehaviorSubject<string>("Bács-Kiskun");

  yr: number = 2011;
  yrSubject: BehaviorSubject<number> = new BehaviorSubject<number>(2011);
